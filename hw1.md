...
<br><img src="./image/a2.png" style="width:300px">
<br/>패치 전 `IcaBindVirChannelByName`

<br><img src="./image/a3.png" style="width:300px">
...
<br><img src="./image/a5.png" style="width:300px"><br/><RDP 연결 순서>
>> - 취약점에 사용되는 **MS_T120** 채널은 **RDP 연결에서 요청되는 채널이 아니며**, MS에서 **용도를 명시하지 않고** 프로그램 내부에서 **31번으로 할당**되어 사용되는 채널이다.<BR>
<br><img src="./image/a6.png" style="width:300px"><BR><정상적인 RDP Initial PDU 패킷>
...
<br><img src="./image/a7.png" style="width:300px"><br><악성 RDP Initial PDU 패킷>
<br><img src="./image/a8.png" style="width:300px"><br><채널 바인딩 상태> 
>> - **채널 2번**을 통해 **MS_T120**채널 객체를 참조하고 있는 **CODE1**에서 동작 중 해당 객체를 **FREE**한 이후에 **채널 31번**을 통해 **CODE2**에서 해당 객체를 사용하면 **UAF취약점**이 발현된다. 
<br><img src="./image/a9.png" style="width:300px"><br><채널 바인딩 상태> 
