...
<br><img src="./image/a3.png" style="width:400px;">
...
<br><img src="./image/a5.png" style="width:400px"><br/><RDP 연결 순서>
>> - 취약점에 사용되는 **MS_T120** 채널은 **RDP 연결에서 요청되는 채널이 아니며**, MS에서 **용도를 명시하지 않고** 프로그램 내부에서 **31번으로 할당**되어 사용되는 채널이다.<BR>
<br><img src="./image/a6.png" style="width:400px"><BR><정상적인 RDP Initial PDU 패킷>
...
<br><img src="./image/a7.png" style="width:400px"><br><악성 RDP Initial PDU 패킷>
<br><img src="./image/a8.png" style="width:400px"><br><채널 바인딩 상태> 
